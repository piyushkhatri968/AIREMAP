...
import { GetAllAdmins } from "../../../lib/APIs/adminAPIs";
        ...
        <div className="bg-zinc-50 dark:bg-[#242526]/90 rounded-xl border border-zinc-200 dark:border-gray-700 overflow-hidden">
          <div className="overflow-x-auto">
            ...
            <table className="w-full min-w-full text-sm">
              <thead>
                <tr className="font-medium text-zinc-500 dark:text-gray-400 border-b bg-zinc-100 dark:bg-[#1c1d1e] border-zinc-200 dark:border-gray-700 whitespace-nowrap">
