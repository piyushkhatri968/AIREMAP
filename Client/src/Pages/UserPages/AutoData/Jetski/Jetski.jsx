...
const makes = [
  ...
  { id: "sea-doo", name: "SEA DOO", logo: "/images/car-logos/sea-doo.png" },
...
const Jetski = () => {
  ...
  const filteredJetskiMakes = makes.filter((make) =>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-500 text-sm">Jetski</span>
              </div>
