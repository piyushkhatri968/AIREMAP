...
const makes = [
  { id: 'arctic-cat', name: 'ARCTIC CAT', logo: '/images/car-logos/arctic-cat.png' },
  { id: 'polaris', name: 'POLARIS', logo: '/images/car-logos/polaris.png' },
  { id: 'ski-doo', name: 'SKI-DOO', logo: '/images/car-logos/ski-doo.png' },
];
...
const SnowMobile = () => {
  ...
  const filteredSnowMobileMakes = makes.filter((make) =>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-500 text-sm">SnowMobile</span>
              </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4">
              {filteredSnowMobileMakes.map((make) => (
                <div
                  key={make.id}
                  onClick={() => {
