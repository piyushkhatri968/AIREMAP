...
const makes = [
  ...
  { id: "bobcat", name: "BOBCAT", logo: "/images/car-logos/bobcat.png" },
  { id: "case", name: "CASE IH", logo: "/images/car-logos/case-ih.png" },
  {
    id: "caterpillar",
    name: "CATERPILLAR",
  ...
  { id: "yanmar", name: "YANMAR", logo: "/images/car-logos/yanmar.png" },
];
...
const Construction = () => {
  ...
  const filteredConstructionMakes = makes.filter((make) =>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-500 text-sm">Construction</span>
              </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4">
              {filteredConstructionMakes.map((make) => (
                <div
                  key={make.id}
                  onClick={() => {
