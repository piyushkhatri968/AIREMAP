...
import { GetAllUsers, GetAssignedUsersToAgent } from "../../../lib/APIs/adminAPIs";
import { Loader2 } from "lucide-react";
import { Button } from "../../../components/ui/button";
import { toast } from "react-toastify";
import useUpdateUserCredits from "../../../hooks/Adminhooks/useUpdateUserCredits";
import { GetAssignedUsers } from "../../../lib/APIs/agentAPIs";
              ...
              {isLoading ? (
                ...
                filteredUsers.map((row, index) => (
                  <motion.tr
                    ...
                    className="border-b border-zinc-200 dark:border-gray-700  transition-colors whitespace-nowrap text-sm"
                  >
