        ...
        <div className="w-full min-h-screen bg-black/40 flex items-center justify-center backdrop-blur-sm">
            ...
            >
                ...
                <p className="mt-6 text-zinc-600 dark:text-zinc-300 leading-relaxed">
                    Your account has been rejected to verify. Please contact our support
                    team for assistance.
                </p>
                {
                    reason && <div className="mt-10">
                        <h1 className="text-2xl font-semibold text-zinc-900 dark:text-white">
                            Reason
                        </h1>
                ...
                <div className="mt-10">
                    <a
                        href="https://mail.google.com/mail/?view=cm&fs=1&to=support@airemap.co.uk"
                        target="_blank"
                    ...
                    <p className="text-zinc-600 dark:text-zinc-300 text-sm mt-8">
                        ...
                        <button
                            className="text-red-600 hover:underline hover:text-red-700 transition-all duration-300"
